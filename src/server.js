...
try {
  ...
  const smartHomeMonitoringRoutes = require('./routes/smart-home-monitoring.routes');
  ...
  // Mount OAuth integration routes
  app.use('/api/oauth', oauthRoutes);
  
  // Mount business integration routes
  app.use('/api/quickbooks', quickbooksRoutes);
  app.use('/api/smart-home-monitoring', smartHomeMonitoringRoutes);
  ...
  console.log('   💼 Business integrations: /api/quickbooks/*, /api/smart-home-monitoring/*');
